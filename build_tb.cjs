...
const tb_code = `Tb=({schedules:r,templates:T,teachers:j,onSelectSchedule:u,onOpenWizard:N,onUpdateLessonStatus:D,onExportBackup:propExportBackup})=>{
...
fs.writeFileSync('tb_new.js', tb_code);
console.log('Successfully wrote tb_new.js, length:', tb_code.length);
try {
  new vm.Script(tb_code);
  console.log('SUCCESS: tb_new.js syntax is valid!');
} catch (e) {
